...
def es_to_df(s_rate, tier, days, host, port):
    """
    Returns data from ES based on the last entries and tier.
    ...
    days (int): number of days history used by training, add 1 in case of missing values
    ...
    # Create a list of the given dates between now and x days before
    ...
    for date in datelist:
        ...
        }, size=2880)  # defined maxiumum size of 2880 entries per day
    ...
    # Slice the dataframe to 720 entries, as used in the trainingprocess
    df = df[-720:]
...
if __name__ == '__main__':
    ...
    # Add Parameters
    parser.add_argument('days', help="Number of days used for training, add 1", type=int)
    ...
    days, host, port, model, index_es = args.days, args.host, args.port, args.model, args.index_es

    df_pic = es_to_df(20, "pic", days, host, port)
    df_cen = es_to_df(20, "censhare", days, host, port)
