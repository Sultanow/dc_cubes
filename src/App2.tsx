...
class App2 extends React.Component<{}, AppState> {
  ...
  constructor(props: object) {
    ...
    this.state = {
      ...
      elasticsearchIndex: 'dc_cubes',
      elasticsearchMergedIndex: 'dc_cubes_forecast',
      elasticsearchForecastIndex: 'dc_cubes_merged',
  ...
  getLogData = () => {
    const dataService = new DataService2(this.state.dataSource,
                                        ...
                                        this.state.elasticsearchForecastIndex,
                                        this.state.elasticsearchMergedIndex,
        ...
        <div className="App">
          ...
          <SidebarNew dataSource={this.state.dataSource}>
            ...
            <Container style={{ display: "contents" }}>
              <Route path="/data-sources" render={(props) => <DataSources2 {...props}
