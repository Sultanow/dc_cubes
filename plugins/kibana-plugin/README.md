...
| Develop **Kibana Visualization Plugin**. | Develop Kibana Visualization Plugin as embedded visualization | High reusability in Kibana: Use Visualization in multiple Dashboards in a simple way. | Hight Effort. Less Flexibility |
