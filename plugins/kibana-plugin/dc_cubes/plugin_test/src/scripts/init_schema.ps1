...
Invoke-RestMethod -Uri "$($solrBaseUrl)schema" -Method Post -Body '{"add-field":{"stored":true,"docValues":true,"indexed":false,"multiValued":false,"name":"host","type":"string"}}' -ContentType "application/json"
...
Invoke-RestMethod -Uri "$($solrBaseUrl)schema" -Method Post -Body '{"add-field":{"stored":true,"docValues":true,"indexed":false,"multiValued":false,"name":"instanz","type":"string"}}' -ContentType "application/json"
Invoke-RestMethod -Uri "$($solrBaseUrl)schema" -Method Post -Body '{"add-field":{"stored":true,"docValues":true,"indexed":false,"multiValued":false,"name":"verfahren","type":"string"}}' -ContentType "application/json"
Invoke-RestMethod -Uri "$($solrBaseUrl)schema" -Method Post -Body '{"add-field":{"stored":true,"docValues":true,"indexed":false,"multiValued":false,"name":"service","type":"string"}}' -ContentType "application/json"
