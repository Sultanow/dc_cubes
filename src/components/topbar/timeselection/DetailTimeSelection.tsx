                        ...
                        <Tabs defaultActiveKey="absolute" id="timespan_from">
                            ...
                            <Tab eventKey="relative" title="Relativ">
                                ...
                                <Container>
                                    <Form.Row>
                                        <Col>
                                            <Form.Control as="select" name="timespanTypeLowerBound" value={this.state.timespanTypeLowerBound} onChange={this.handleLocalChangeLowerBound}>
                                                <option value="last">Letzte</option>
                                                <option value="next">Nächste</option>
                                            </Form.Control>
                                        </Col>
                                        <Col>
                                            <Form.Control type="number" name="timespanAmountLowerBound" min="1" max="9999" value={this.props.timespanAmountLowerBound} onChange={this.handleChangeLowerBound}/>
                                        </Col>
                                        <Col>
                                            <Form.Control as="select" name="timespanTimeUnitLowerBound" value={this.props.timespanTimeUnitLowerBound} onChange={this.handleChangeLowerBound}>
                        ...
                        <Tabs defaultActiveKey="absolute" id="timespan_from">
                            ...
                            <Tab eventKey="relative" title="Relativ">
                                ...
                                <Container>
                                    <Form.Row>
                                        <Col>
                                            <Form.Control as="select" name="timespanTypeUpperBound" value={this.state.timespanTypeUpperBound} onChange={this.handleLocalChangeUpperBound}>
                                                <option value="last">Letzte</option>
                                                <option value="next">Nächste</option>
                                            </Form.Control>
                                        </Col>
                                        <Col>
                                            <Form.Control type="number" name="timespanAmountUpperBound" min="1" max="9999" value={this.props.timespanAmountUpperBound} onChange={this.handleChangeUpperBound}/>
                                        </Col>
                                        <Col>
                                            <Form.Control as="select" name="timespanTimeUnitUpperBound" value={this.props.timespanTimeUnitUpperBound} onChange={this.handleChangeUpperBound}>
                                                <option value="seconds">Sekunden</option>
                                                <option value="minutes">Minuten</option>
                                                <option value="hours">Stunden</option>
                                                <option value="days">Tage</option>
